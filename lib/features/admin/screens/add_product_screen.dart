...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  final TextEditingController quanitytyContoller = TextEditingController();
  ...
  void sellProduct(){
    if(_addProductFormKey.currentState!.validate() && images.isNotEmpty){
      adminServices.sellProduct(
        ...
        quantity: double.parse(quanitytyContoller.text), 
            ...
            child: Column(
              children:[
                ...
                CarouselSlider(items: images.map((i){
                  return Builder(builder:(BuildContext context) => Image.file(i, 
                ...
                : GestureDetector(
                  ...
                  CustomTextfield(controller: productNameContoller, 
                  hintText: 'Product Name',),
                  const SizedBox(height: 10,),
                  CustomTextfield(controller: descriptionContoller, 
                  hintText: 'Description',
                  maxLines: 7,),
                  const SizedBox(height: 10,),
                  CustomTextfield(controller: priceContoller, 
                  hintText: 'Price',),
                  const SizedBox(height: 10,),
                  CustomTextfield(controller: quanitytyContoller, 
                  hintText: 'quantity',),
                  const SizedBox(height: 10,),

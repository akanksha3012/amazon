...
import 'package:amazon/features/cart/widgets/cat_product.dart';
...
Widget build(BuildContext context) {
  ...
  int sum = user.cart
      .map((e) => e['quantity'] * e['product']['price'] as int)
      .fold(0, (previousValue, element) => previousValue + element);

  // Calculate the total number of items
  int totalItemCount = user.cart
      .map((e) => e['quantity'] as int)  // Cast quantity to int
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: CustomButton(
              text: 'Proceed to Buy ($totalItemCount items)', // Correct total item count
